...
curl -k -v -i -X POST -H "Content-Type: multipart/form-data" -F "file=@./$file" -u $user:$password "https://$server:6182/service/plugins/policies/importPoliciesFromFile?isOverride=false"
